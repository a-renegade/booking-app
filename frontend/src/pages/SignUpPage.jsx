      ...
      <div className="min-h-screen  flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="bg-white shadow-xl rounded-2xl w-full max-w-md p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium">userType</span>
              </label>
              <div className="border-1 rounded relative">
            ...
            <button type="submit" className="flex justify-center items-center border-1 rounded w-full" disabled={isSigningUp}>
              {isSigningUp ? (
                <>
          ...
          <div className="text-center">
            <p className="text-base-content/60">
              ...
              <Link to="/login" className="underline link link-primary">
                Sign in
              </Link>
            </p>
          </div>
